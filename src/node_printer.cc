...
NAN_MODULE_INIT(Init) {
  ...
  MY_MODULE_SET_METHOD(target, "getPrinterDriverOptions",
  ...
  MY_MODULE_SET_METHOD(target, "getSupportedPrintFormats",
                       getSupportedPrintFormats);
  MY_MODULE_SET_METHOD(target, "getSupportedJobCommands",
