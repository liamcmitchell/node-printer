...
#define MY_NODE_MODULE_HANDLESCOPE                                             \
  MY_NODE_MODULE_ISOLATE_DECL Nan::HandleScope scope
...
#define V8_STRING_NEW_UTF8(value)                                              \
  v8::String::NewFromUtf8(MY_NODE_MODULE_ISOLATE, value,                       \
                          v8::NewStringType::kNormal)                          \
      .ToLocalChecked()
#define V8_STRING_NEW_2BYTES(value)                                            \
  v8::String::NewFromTwoByte(MY_NODE_MODULE_ISOLATE, value,                    \
                             v8::NewStringType::kNormal)                       \
      .ToLocalChecked()
#elif NODE_VERSION_AT_LEAST(0, 11, 10)
#if NODE_MODULE_VERSION > 73
#define V8_STRING_NEW_UTF8(value)                                              \
  v8::String::NewFromUtf8(MY_NODE_MODULE_ISOLATE, value).ToLocalChecked()
#define V8_STRING_NEW_2BYTES(value)                                            \
  v8::String::NewFromTwoByte(MY_NODE_MODULE_ISOLATE, value).ToLocalChecked()
#else
#define V8_STRING_NEW_UTF8(value)                                              \
  v8::String::NewFromUtf8(MY_NODE_MODULE_ISOLATE, value)
#define V8_STRING_NEW_2BYTES(value)                                            \
...
#define V8_LOCAL_STRING_FROM_VALUE(value)                                      \
  value->ToString(Nan::GetCurrentContext()).FromMaybe(v8::Local<v8::String>())
...
#define MY_MODULE_SET_METHOD(exports, name, method)                            \
  Nan::SetMethod(exports, name, method)
#define MY_NODE_MODULE_CALLBACK(name)                                          \
  void name(const Nan::FunctionCallbackInfo<v8::Value> &iArgs)
#else
#define MY_MODULE_SET_METHOD(exports, name, method)                            \
  NODE_SET_METHOD(exports, name, method)
#define MY_NODE_MODULE_CALLBACK(name)                                          \
  void name(const v8::FunctionCallbackInfo<v8::Value> &iArgs)
#endif
